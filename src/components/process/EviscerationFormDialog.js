...
export default function EviscerationFormDialog(props) {
      ...
      <DialogContent>
        {
          isLoading ?
            ...
            <>
              ...
              <form id="EviscerationForm" noValidate autoComplete="off" onSubmit={handleFormSubmit}>
